...
- **Acceptance:** `src/ShareExtension/UnitTests/ShareExtensionManagerTests.swift::testProcess_ProviderErrorKeepsItsUserFacingMessage` | `./run check`
- **Status:** [x]
...
- **Tasks:** [REF:task:2026-07-operation-tiles-on-both-screens | operation-tiles-on-both-screens]
- **Acceptance:** `src/Common/UnitTests/OperationGridTests.swift::testCellsKeepGapsBetweenOccupiedSlots` | `./run check` | `src/MainApp/UITests/OperationEditingUITests.swift::testLongPressDragMovesTileWithoutSecondPress` | `tuist test UITests --no-selective-testing --test-targets MainAppUITests/OperationEditingUITests`
- **Status:** [x]
